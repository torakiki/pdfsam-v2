 ...
 */
package it.pdfsam.plugin.coverfooter.model;
 ...
 */
public class CoverFooterTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int row, int col) {
        return ((CoverFooterItemType) data.get(row)).getValue(col);
    }

    /**
     * Return the value at row, col
     */
    public CoverFooterItemType getRow(int row) {
        return ((CoverFooterItemType) data.get(row));
    }
     ...
     * */
    public void setData(CoverFooterItemType[] input_data){
        data.clear();
