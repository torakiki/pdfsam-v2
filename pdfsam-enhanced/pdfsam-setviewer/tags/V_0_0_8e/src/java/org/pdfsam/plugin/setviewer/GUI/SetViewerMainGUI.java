 ...
 */
public class SetViewerMainGUI extends AbstractPlugablePanel {
    ...
    private void initialize() {
        ...
        setviewerOptionsPanel.setBorder(BorderFactory.createTitledBorder(GettextResource.gettext(config
                .getI18nResourceBundle(), "Set viewer options")));
        // checks
        ...
        hideMenuBar.setText(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),
                "Hide the menubar"));
        hideMenuBar.setSelected(false);

        hideToolBar.setText(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),
                "Hide the toolbar"));
        hideToolBar.setSelected(false);

        hideUIElements.setText(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),
                "Hide user interface elements"));
        hideUIElements.setSelected(false);

        resizeToFit.setText(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),
                "Rezise the window to fit the page size"));
        resizeToFit.setSelected(false);

        centerScreen.setText(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),
                "Center of the screen"));
        centerScreen.setSelected(false);

        displayTitle.setText(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),
                "Display document title as window title"));
        displayTitle.setToolTipText(GettextResource.gettext(config.getI18nResourceBundle(), "Pdf version required:")
                + " 1.4");
        displayTitle.addItemListener(new VersionFilterCheckBoxItemListener(versionCombo, new Integer(""
                + AbstractParsedCommand.VERSION_1_4)));
        displayTitle.setSelected(false);

        noPageScaling.setText(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),
                "No page scaling in print dialog"));
        noPageScaling.setSelected(false);
        noPageScaling.setToolTipText(GettextResource.gettext(config.getI18nResourceBundle(), "Pdf version required:")
                + " 1.6");
        noPageScaling.addItemListener(new VersionFilterCheckBoxItemListener(versionCombo, new Integer(""
                + AbstractParsedCommand.VERSION_1_6)));

        checksLayout.setHorizontalGroup(checksLayout.createSequentialGroup().addGroup(
                checksLayout.createParallelGroup().addComponent(hideMenuBar).addComponent(resizeToFit).addComponent(
                        noPageScaling)).addGroup(
                checksLayout.createParallelGroup().addComponent(hideToolBar).addComponent(centerScreen)).addGroup(
                checksLayout.createParallelGroup().addComponent(hideUIElements).addComponent(displayTitle)));
        checksLayout.setVerticalGroup(checksLayout.createSequentialGroup().addGroup(
                checksLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(hideMenuBar)
                        .addComponent(hideToolBar).addComponent(hideUIElements)).addGroup(
                checksLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(resizeToFit)
                        .addComponent(centerScreen).addComponent(displayTitle)).addGroup(
                checksLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(noPageScaling)));
        ...
        directionCombo.setToolTipText(GettextResource.gettext(config.getI18nResourceBundle(), "Pdf version required:")
                + " 1.3");
        ...
        combosLayout
                .setHorizontalGroup(combosLayout.createSequentialGroup()
                        .addGroup(
                                combosLayout.createParallelGroup().addComponent(viewerLayoutLabel).addComponent(
                                        directionLabel)).addGroup(
                                combosLayout.createParallelGroup().addComponent(viewerLayout).addComponent(
                                        directionCombo)).addGroup(
                                combosLayout.createParallelGroup().addComponent(viewerOpenModeLabel).addComponent(
                                        nonFullScreenModeLabel)).addGroup(
                                combosLayout.createParallelGroup().addComponent(viewerOpenMode).addComponent(
                                        nonFullScreenMode)));
        combosLayout.setVerticalGroup(combosLayout.createSequentialGroup().addGroup(
                combosLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(viewerLayoutLabel)
                        .addComponent(viewerLayout).addComponent(viewerOpenModeLabel).addComponent(viewerOpenMode))
                .addGroup(
                        combosLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(directionLabel)
                                .addComponent(directionCombo).addComponent(nonFullScreenModeLabel).addComponent(
                                        nonFullScreenMode)));
        ...
        runButton.setToolTipText(GettextResource.gettext(config.getI18nResourceBundle(),
    ...
    private Vector<StringItem> getDirectionComboItems() {
        ...
        retVal.add(new StringItem(SetViewerParsedCommand.D_L2R, GettextResource.gettext(config.getI18nResourceBundle(),
                "Left to right")));
        retVal.add(new StringItem(SetViewerParsedCommand.D_R2L, GettextResource.gettext(config.getI18nResourceBundle(),
                "Right to left")));
        return retVal;
    }
    ...
    private Vector<StringItem> getViewerOpenModeItems() {
        ...
        retVal.add(new StringItem(SetViewerParsedCommand.M_NONE, GettextResource.gettext(
                config.getI18nResourceBundle(), "None")));
        retVal.add(new StringItem(SetViewerParsedCommand.M_FULLSCREEN, GettextResource.gettext(config
                .getI18nResourceBundle(), "Fullscreen")));
        retVal.add(new StringItem(SetViewerParsedCommand.M_ATTACHMENTS, GettextResource.gettext(config
                .getI18nResourceBundle(), "Attachments")));
        retVal.add(new StringItem(SetViewerParsedCommand.M_OCONTENT, GettextResource.gettext(config
                .getI18nResourceBundle(), "Optional content group panel")));
        retVal.add(new StringItem(SetViewerParsedCommand.M_OUTLINES, GettextResource.gettext(config
                .getI18nResourceBundle(), "Document outline")));
        retVal.add(new StringItem(SetViewerParsedCommand.M_THUMBS, GettextResource.gettext(config
                .getI18nResourceBundle(), "Thumbnail images")));
        return retVal;
    }
    ...
    private Vector<StringItem> getViewerNonFullScreenItems() {
        ...
        retVal.add(new StringItem(SetViewerParsedCommand.NFSM_NONE, GettextResource.gettext(config
                .getI18nResourceBundle(), "None")));
        retVal.add(new StringItem(SetViewerParsedCommand.NFSM_OCONTENT, GettextResource.gettext(config
                .getI18nResourceBundle(), "Optional content group panel")));
        retVal.add(new StringItem(SetViewerParsedCommand.NFSM_OUTLINES, GettextResource.gettext(config
                .getI18nResourceBundle(), "Document outline")));
        retVal.add(new StringItem(SetViewerParsedCommand.NFSM_THUMBS, GettextResource.gettext(config
                .getI18nResourceBundle(), "Thumbnail images")));
        return retVal;
    }
    ...
    private Vector<StringItem> getViewerLayoutItems() {
        Vector<StringItem> retVal = new Vector<StringItem>(6);
        retVal.add(new StringItem(SetViewerParsedCommand.L_SINGLEPAGE, GettextResource.gettext(config
                .getI18nResourceBundle(), "One page at a time")));
        retVal.add(new StringItem(SetViewerParsedCommand.L_ONECOLUMN, GettextResource.gettext(config
                .getI18nResourceBundle(), "Pages in one column")));
        retVal.add(new StringItem(SetViewerParsedCommand.L_TWOCOLUMNLEFT, GettextResource.gettext(config
                .getI18nResourceBundle(), "Pages in two columns (odd on the left)")));
        retVal.add(new StringItem(SetViewerParsedCommand.L_TWOCOLUMNRIGHT, GettextResource.gettext(config
                .getI18nResourceBundle(), "Pages in two columns (odd on the right)")));
        retVal.add(new StringItem(SetViewerParsedCommand.L_TWOPAGELEFT, GettextResource.gettext(config
                .getI18nResourceBundle(), "Two pages at a time (odd on the left)")));
        retVal.add(new StringItem(SetViewerParsedCommand.L_TWOPAGERIGHT, GettextResource.gettext(config
                .getI18nResourceBundle(), "Two pages at a time (odd on the right)")));
        return retVal;
    }
    ...
    private void setLayout() {
        ...
        setviewerOptionPanelLayout.putConstraint(SpringLayout.SOUTH, outPrefixLabel, 20, SpringLayout.NORTH,
                outputOptionsPanel);
        setviewerOptionPanelLayout.putConstraint(SpringLayout.NORTH, outPrefixLabel, 5, SpringLayout.NORTH,
                outputOptionsPanel);
        setviewerOptionPanelLayout.putConstraint(SpringLayout.WEST, outPrefixLabel, 5, SpringLayout.WEST,
                outputOptionsPanel);
        setviewerOptionPanelLayout.putConstraint(SpringLayout.SOUTH, outPrefixTextField, 0, SpringLayout.SOUTH,
                outPrefixLabel);
        setviewerOptionPanelLayout.putConstraint(SpringLayout.WEST, outPrefixTextField, 10, SpringLayout.EAST,
                outPrefixLabel);
        setviewerOptionPanelLayout.putConstraint(SpringLayout.EAST, outPrefixTextField, -30, SpringLayout.EAST,
                outputOptionsPanel);

        setviewerOptionPanelLayout.putConstraint(SpringLayout.SOUTH, prefixHelpLabel, -1, SpringLayout.SOUTH,
                outputOptionsPanel);
        setviewerOptionPanelLayout.putConstraint(SpringLayout.EAST, prefixHelpLabel, -1, SpringLayout.EAST,
                outputOptionsPanel);

        optionsPanelLayout.putConstraint(SpringLayout.NORTH, setviewerOptsComboPanel, 10, SpringLayout.NORTH,
                setviewerOptionsPanel);
        optionsPanelLayout.putConstraint(SpringLayout.WEST, setviewerOptsComboPanel, 5, SpringLayout.WEST,
                setviewerOptionsPanel);

        optionsPanelLayout.putConstraint(SpringLayout.NORTH, setviewerOptsCheckPanel, 10, SpringLayout.SOUTH,
                setviewerOptsComboPanel);
        optionsPanelLayout.putConstraint(SpringLayout.WEST, setviewerOptsCheckPanel, 0, SpringLayout.WEST,
                setviewerOptsComboPanel);
    ...
    /**
     * 
     * @author Andrea Vacondio Focus policy for set viewer panel
     * 
     */
