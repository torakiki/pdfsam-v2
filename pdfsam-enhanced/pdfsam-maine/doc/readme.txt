...
Linked libraries:
	...
	-jaxen-1.1
	-dom4j-1.6.1
	-pdfsam-console-0.7.1e *
	-pdfsam-langpack *
	
Note: This is a test version and many fixes have to be done. PDF Split and Merge comes with ABSOLUTELY NO WARRANTY;
see the file license.txt for details.

Installation: Unzip the archive into a directory. Double click pdfsam-1.2.0e-beta.jar or open a console a type the command
