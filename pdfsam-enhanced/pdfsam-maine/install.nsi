...
;get language
  ...
  File "doc\pdfsam-1.2.0e-alpha-tutorial.pdf"
  SetOutPath "$INSTDIR\plugins\merge"
  File "plugins\merge\pdfsam-merge-0.4.7e.jar"
  File "plugins\merge\config.xml"
  SetOutPath "$INSTDIR\plugins\split"
  File "plugins\split\pdfsam-split-0.2.9e.jar"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\Tutorial.lnk" "$INSTDIR\doc\pdfsam-1.2.0e-alpha-tutorial.pdf"
...
Section Uninstall
  ...
  Delete "$INSTDIR\plugins\split\pdfsam-split-0.2.9e.jar"
