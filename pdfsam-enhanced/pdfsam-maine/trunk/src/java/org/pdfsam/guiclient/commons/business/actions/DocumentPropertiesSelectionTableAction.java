 ...
 * 
 */
public class DocumentPropertiesSelectionTableAction extends AbstractAction {
	...
	public DocumentPropertiesSelectionTableAction(JPdfSelectionTable mainTable) {
		super(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(), "Document properties"));
		this.setEnabled(true);
		this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_P, InputEvent.ALT_DOWN_MASK));
		this.putValue(Action.SHORT_DESCRIPTION, GettextResource.gettext(Configuration.getInstance()
				.getI18nResourceBundle(), "Show document properties"));
		this.putValue(Action.SMALL_ICON, new ImageIcon(this.getClass().getResource("/images/info.png")));
