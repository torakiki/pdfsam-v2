...
Installation: Unzip the archive into a directory. Double click pdfsam-1.1.1.jar or open a console a type the command
"java -jar /pathwhereyouunzipped/pdfsam-1.1.1.jar"
