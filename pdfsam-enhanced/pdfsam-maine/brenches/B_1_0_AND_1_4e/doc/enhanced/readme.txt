...
Installation: Unzip the archive into a directory. Double click pdfsam-1.4.2e.jar or open a console a type the command
"java -jar /pathwhereyouunzipped/pdfsam-1.4.2e.jar"
