...
public class  PlugInsLoader{
    ...
    static final Class PLUGIN_SUPER_CLASS = it.pdfsam.abstracts.AbstractPlugIn.class;
    /**
     * Constructor
    ...
    public Object loadPlugin(int num)  throws PluginLoadException {
        ...
        if (counter != 1){
            ...
            try{
            	...
            	throw new PluginLoadException("Permission exception loading plugin. "+se.getMessage());
            }
            catch (ClassNotFoundException cnf_exception){
                throw new PluginLoadException("Unable to load class, class not found. "+cnf_exception.getMessage());
            }
            catch (Exception e_exception){
                throw new PluginLoadException(e_exception.getMessage());
            }
            Class superclass = cls.getSuperclass();
            if (superclass.isAssignableFrom(PLUGIN_SUPER_CLASS)){
