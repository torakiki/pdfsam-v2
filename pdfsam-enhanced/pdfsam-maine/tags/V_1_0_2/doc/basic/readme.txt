...
Installation: Unzip the archive into a directory. Double click pdfsam-1.0.2.jar or open a console a type the command
"java -jar /pathwhereyouunzipped/pdfsam-1.0.2.jar"
