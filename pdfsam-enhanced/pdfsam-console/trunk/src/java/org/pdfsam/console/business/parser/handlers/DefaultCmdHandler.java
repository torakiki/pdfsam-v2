...
public class DefaultCmdHandler implements CmdHandler {
	...
	public CmdLineHandler getCommandLineHandler() {
		if(commandLineHandler == null){ 
			commandLineHandler = new VersionCmdLineHandler(ConsoleServicesFacade.CREATOR,new HelpCmdLineHandler(getHelpMessage(),COMMAND,getCommandDescription(),getOptions(),getArguments()));
