...
public class DocInfoMainGUI extends AbstractPlugablePanel {
	...
	private JPdfSelectionPanel selectionPanel = new JPdfSelectionPanel(JPdfSelectionPanel.SINGLE_SELECTABLE_FILE, AbstractPdfSelectionTableModel.DEFAULT_SHOWED_COLUMNS_NUMBER, true, false);
	...
	private JTextField titleTextField = CommonComponentsFactory.getInstance().createTextField(CommonComponentsFactory.SIMPLE_TEXT_FIELD_TYPE);
	private JTextField authorTextField = CommonComponentsFactory.getInstance().createTextField(CommonComponentsFactory.SIMPLE_TEXT_FIELD_TYPE);
	private JTextField subjectTextField = CommonComponentsFactory.getInstance().createTextField(CommonComponentsFactory.SIMPLE_TEXT_FIELD_TYPE);
...
//		DOCINFO PANEL	
		docInfoPanel.setBorder(BorderFactory.createTitledBorder(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Document metadata")));
        ...
        sb1.append("<html><body><b>"+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Document metadata")+"</b>");
        sb1.append("<p> "+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Set the document title.")+"</p>");
        sb1.append("<p> "+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Set the document author.")+"</p>");
        sb1.append("<p> "+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Set the document subject.")+"</p>");
        sb1.append("<p> "+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Set the document keywords.")+"</p>");
		...
		docinfoLayout.setHorizontalGroup(
				docinfoLayout.createSequentialGroup()      		      
        		      .addGroup(docinfoLayout.createParallelGroup()
        		           .addComponent(titleLabel)
        		           .addComponent(authorLabel)
        		           .addComponent(subjectLabel)
        		           .addComponent(keywordsLabel))
         		      .addGroup(docinfoLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
		...
		docinfoLayout.setVerticalGroup(
				docinfoLayout.createSequentialGroup()
        		      .addGroup(docinfoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
        		           .addComponent(titleLabel)
        		           .addComponent(titleTextField))
        		      .addGroup(docinfoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
        		           .addComponent(authorLabel)
...
//		DESTINATION_PANEL
		...
		TitledBorder titledBorder = BorderFactory.createTitledBorder(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Destination output file"));
...
//      HELP_LABEL_DESTINATION        
        String helpTextDest = 
    		"<html><body><b>"+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Destination output file")+"</b>" +
    		"<p>"+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Browse or enter the full path to the destination output file.")+"</p>"+
    		"<p>"+GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Check the box if you want to overwrite the output file if it already exists.")+"</p>"+
...
//END_RADIO_LISTENERS
	...
	public void loadJobNode(Node arg0) throws LoadJobException {		
		try{	
			...
			log.info(GettextResource.gettext(Configuration.getInstance().getI18nResourceBundle(),"Rotate section loaded."));  
        }
		catch (Exception ex){
