...
!define PRODUCT_NAME "PDF Split and Merge"
!define PRODUCT_VERSION "0.6 stable release"
!define PRODUCT_PUBLISHER "Andrea Vacondio"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "NSIS:StartMenuDir"
!define TARGET_FILE "config.xml"
!define PRODUCT_DATE "07/09/2006"
...
OutFile "pdfsam-win32inst-v0_6_sr.exe"
...
Function WarnDirExists    
    ...
    MessageBox MB_YESNO|MB_ICONQUESTION|MB_DEFBUTTON2 \
        "Installation directory already exists, please uninstall any previous version of pdfsam. Would you like to install anyway?" \
        IDYES DirExistsOK
    Abort
    DirExistsOK:
FunctionEnd
...
;get language
  ...
  SetOverwrite on
  SetOutPath "$INSTDIR\lib"
  File "lib\pdfsam-console-0.5.2.jar"
  File "lib\jcmdline-1.0.3.jar"
  File "lib\looks-2.0.1.jar"
  File "lib\itext-1.4.4.jar"
  File "lib\pdfsam-langpack.jar"  
  SetOverwrite ifnewer
  SetOutPath "$INSTDIR"
  File "pdfsam-0.6sr.jar"
  SetOutPath "$INSTDIR\doc"
  File "doc\readme.txt"
  File "doc\changelog.txt"
  File "doc\License.txt"
  File "doc\pdfsam-0.6sr-tutorial.pdf"
  SetOutPath "$INSTDIR\plugins\merge"
  File "plugins\merge\pdfsam-merge-0.4.4.jar"
  File "plugins\merge\config.xml"
  SetOutPath "$INSTDIR\plugins\split"
  File "plugins\split\pdfsam-split-0.2.7.jar"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\pdfsam.lnk" "$INSTDIR\pdfsam-0.6sr.jar"
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\readme.lnk" "$INSTDIR\doc\readme.txt"
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\tutorial.lnk" "$INSTDIR\doc\pdfsam-0.6sr-tutorial.pdf"
...
Section Uninstall
  ...
  Delete "$INSTDIR\plugins\split\pdfsam-split-0.2.7.jar"
  Delete "$INSTDIR\plugins\merge\config.xml"
  Delete "$INSTDIR\plugins\merge\pdfsam-merge-0.4.4.jar"
  Delete "$INSTDIR\pdfsam-0.6sr.jar"
  Delete "$INSTDIR\doc\readme.txt"
  Delete "$INSTDIR\doc\changelog.txt"
  Delete "$INSTDIR\doc\License.txt"
  Delete "$INSTDIR\doc\pdfsam-0.6sr-tutorial.pdf"  
  Delete "$INSTDIR\lib\pdfsam-console-0.5.2.jar"
  Delete "$INSTDIR\lib\jcmdline-1.0.3.jar"
  Delete "$INSTDIR\lib\looks-2.0.1.jar"
  Delete "$INSTDIR\lib\itext-1.4.4.jar"
